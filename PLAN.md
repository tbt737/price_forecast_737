...
> Current (2026-09-26, re-measured): **pytest 600 + 1 skipped · vitest 39 · 52
...
> DIESEL_VN joined after the 2026-07-11 snapshot that this line used to carry. (AUDIT-1B's
> 599 baseline is stale — RESTATE-COVERAGE-1 added one test; see `.claude/loop-memory.md`.)
