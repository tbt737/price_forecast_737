...
def test_forecast_commodity_insufficient_history(seeded_session):
    ...
    db_session.execute(text(
        "INSERT INTO dim_market_instrument (market_instrument_key, commodity_key, "
        "instrument_code, exchange) "
    ...
    for i in range(10):
        db_session.execute(text(f"""
            INSERT INTO fact_price_daily (commodity_key, data_source_key, market_instrument_key,
                                          price_date, close, value, release_date, revision)
