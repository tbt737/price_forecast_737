...
class StockReconcileConfig:
    ...
    # single-basis read serves only the latest revision, so any date the reload drops
    # would silently vanish from every read path forever, not just get "less coverage"
