...
- Guard chống reload cụt: `min_reload_coverage` (1.0) — series mới phải phủ **100%** số
  ...
  basis cũ). Chặn việc một response bị cắt ngắn (kể cả thiếu 1 ngày) trở thành series
  canonical — trước đây ngưỡng 0.9 từng để lọt một reload thiếu 2/20 ngày (AUDIT-1B).
